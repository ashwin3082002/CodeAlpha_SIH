"""
Django settings for sipportal project.
...
ALLOWED_HOSTS = ['student-identification-portal.el.r.appspot.com','sip.ashwinr.dev']
...
WSGI_APPLICATION = 'sipportal.wsgi.application'
